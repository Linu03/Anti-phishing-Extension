...
from app.layers.page_template.rules.favicon_brand import evaluate_favicon_brand

BACKEND_ROOT = Path(__file__).resolve().parents[1]
FIXTURES_DIR = BACKEND_ROOT / "scripts" / "fixtures" / "favicon_brand"
...
def main() -> None:
    ...
    for path in fixture_paths:
        ...
        if match is None:
            ...
            findings = evaluate_favicon_brand(
                match,
                page_host,
                page_url,
